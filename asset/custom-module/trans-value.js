...
export async function getCharacterProfile(data, dataBase) {
    ...
    function medianInfoExtract() {
        ...
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.dealerMedianValue = 866.13;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.dealerMedianValue = 938.98;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.dealerMedianValue = 987.02;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.dealerMedianValue = 1021.46;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.dealerMedianValue = 1389.79;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.dealerMedianValue = 1564.45;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.dealerMedianValue = 1631.14;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.dealerMedianValue = 1705.80;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.dealerMedianValue = 1805.55;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.dealerMedianValue = 1959.17;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.dealerMedianValue = 2041.12;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.dealerMedianValue = 2077.61;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.dealerMedianValue = 2256.82;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.dealerMedianValue = 2385.78;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.dealerMedianValue = 2529.55;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.dealerMedianValue = 2691.98;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.dealerMedianValue = 2870.11;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.dealerMedianValue = 3107.81;
        } else if (itemLevel >= 1750) {
            result.dealerMedianValue = 3409.78;
        }

        // console.log(itemLevel)
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.supportMedianValue = 1210.02;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.supportMedianValue = 1230.36;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.supportMedianValue = 1282.27;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.supportMedianValue = 1341.25;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.supportMedianValue = 1535.67;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.supportMedianValue = 1628.87;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.supportMedianValue = 1678.73;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.supportMedianValue = 1745.07;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.supportMedianValue = 1828.44;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.supportMedianValue = 1947.88;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.supportMedianValue = 2021.14;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.supportMedianValue = 2050.76;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.supportMedianValue = 2216.79;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.supportMedianValue = 2431.43;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.supportMedianValue = 2598.05;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.supportMedianValue = 2745.10;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.supportMedianValue = 2863.90;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.supportMedianValue = 3008.50;
        } else if (itemLevel >= 1750) {
            result.supportMedianValue = 3221.85;
        }
