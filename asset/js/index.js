...
`
    ...
    //},
    {
        name: `시뮬레이터 분석기 출시 안내 (Feat.해널)`,
        desc:
            `현재 버그 발견으로 인해 잠시 웹스토어에서 내려둔 상태입니다.
            빠른 시일내로 다시 제공해드리도록 하겠습니다!`
    },
    {
    ...
    {
        name: `<em style="font-weight:900;font-size:17px;">2025-05-06 업데이트 안내</em>`,
        desc:
            `● 서폿 대개편
            &nbsp;&nbsp; - 서폿 대개편이 완료되었습니다.
    ...
    {
        name: `<em style="font-weight:900;font-size:17px;">2025-05-06 핫픽스 안내</em>`,
        desc:
    ...
    {
        name: `<em style="font-weight:900;font-size:17px;">2025-05-07 핫픽스 안내</em>`,
        desc:
            `● 도약 포인트 점수 하향
