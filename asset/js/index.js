...
`
    ...
    {
        name:`<em style="font-weight:600;font-size:15px;">2025-01-22 업데이트 안내</em>`,
        desc:
    ...
    {
        name:`<em style="font-weight:600;font-size:15px;">2025-01-23 업데이트 안내</em>`,
        desc:
        `서폿 고도화 작업이 완료되었습니다.
        저번 공지에서 말씀드렸듯, 앞으로 격변은 없을 예정입니다.
        고도화 내역은 아래와 같습니다.
